      ...
      export module util {
        ...
        export module ThreadUtil {
          export class BackgroundCallback {
             ...
             */
            public constructor(implementation: { refresh(param0: number): void; updateRange(param0: number, param1: number, param2: number, param3: number, param4: number): void; loadTile(param0: number, param1: number): void; recycleTile(param0: android.support.v7.util.TileList.Tile): void });
          ...
          export class MainThreadCallback {
             ...
             */
            public constructor(implementation: { updateItemCount(param0: number, param1: number): void; addTile(param0: number, param1: android.support.v7.util.TileList.Tile): void; removeTile(param0: number, param1: number): void });
      ...
      export module widget {
        ...
        export module OpReorderer {
          export class Callback {
             ...
             */
            public constructor(implementation: { obtainUpdateOp(param0: number, param1: number, param2: number, param3: javalangObject): android.support.v7.widget.AdapterHelper.UpdateOp; recycleUpdateOp(param0: android.support.v7.widget.AdapterHelper.UpdateOp): void });
            public obtainUpdateOp(param0: number, param1: number, param2: number, param3: javalangObject): android.support.v7.widget.AdapterHelper.UpdateOp;
            public recycleUpdateOp(param0: android.support.v7.widget.AdapterHelper.UpdateOp): void;
          }
        }
        ...
        export module RecyclerView {
          ...
          export module ItemAnimator {
            ...
            export class ItemAnimatorListener {
               ...
               */
              public constructor(implementation: { onAnimationFinished(param0: android.support.v7.widget.RecyclerView.ViewHolder): void });
              public onAnimationFinished(param0: android.support.v7.widget.RecyclerView.ViewHolder): void;
            }
          ...
          export class OnChildAttachStateChangeListener {
             ...
             */
            public constructor(implementation: { onChildViewAttachedToWindow(param0: android.view.View): void; onChildViewDetachedFromWindow(param0: android.view.View): void });
          ...
          export class OnItemTouchListener {
             ...
             */
            public constructor(implementation: { onInterceptTouchEvent(param0: android.support.v7.widget.RecyclerView, param1: android.view.MotionEvent): boolean; onTouchEvent(param0: android.support.v7.widget.RecyclerView, param1: android.view.MotionEvent): void; onRequestDisallowInterceptTouchEvent(param0: boolean): void });
          ...
          export class RecyclerListener {
             ...
             */
            public constructor(implementation: { onViewRecycled(param0: android.support.v7.widget.RecyclerView.ViewHolder): void });
            public onViewRecycled(param0: android.support.v7.widget.RecyclerView.ViewHolder): void;
          }
        ...
        export module helper {
          ...
          export module ItemTouchHelper {
            ...
            export class ViewDropHandler {
               ...
               */
              public constructor(implementation: { prepareForDrop(param0: android.view.View, param1: android.view.View, param2: number, param3: number): void });
              public prepareForDrop(param0: android.view.View, param1: android.view.View, param2: number, param3: number): void;
            }
          }
        }
